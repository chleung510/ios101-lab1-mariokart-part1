...
class ViewController: UIViewController,
  ...
  //  Called when user double-taps a kart
    // IBAction keyword is for connecting the UI to this function
    // sender is an object that detects tapping gesture
    // _ is...
  ...
  @IBAction func didPinchKart(_ sender: UIPinchGestureRecognizer) {
    ...
    // Tip: Use the `scale` function below
      //pass in sender.view and sender to it as the kart and gestureRecognizer arguments, respectively.
